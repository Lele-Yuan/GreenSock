...
const initElectric = () => {
    ...
    // 图片地址
    const sectionCurrentFrame = index => `${pathName}/electric/jpg/${systemName}/cs1${indexName(index + 1)}.jpg`;
    // const sectionCurrentFrame = index => `${pathName}/electric/webp/${systemName}/cs1${indexName(index + 1)}.webp`;
    initGsap('section1', {
