...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        FP.reBuild = function(resizing){
            ...
            $(SECTION_SEL).each(function(){
                ...
                if(options.verticalCentered){
                    ...
                    $(this).find(TABLE_CELL_SEL).css('max-height', getTableHeight($(this)) + 'px');
                }
  
                $(this).css('height', windowsHeight + 'px');
                // if ($(this).find('.cmp-app-download').length && $('.stickyFeatureMenu').length) {
                //     console.log('sect', $(this))
                //     let wh = windowsHeight - 96;
        ...
        */
        function styleSection(section, index){
            ...
            if (section.find('.cmp-app-download').length && $('.stickyFeatureMenu').length) {
              console.log('sect', section)
              let wh = windowsHeight - 96;
              section.css('height', wh + 'px');
              section.css('max-height', wh + 'px');
            } else {
                section.css('height', windowsHeight + 'px');
                section.css('max-height', windowsHeight + 'px');
            }
        ...
        */
        function getScrollSettings(v){
            ...
            if(options.autoScrolling && !options.scrollBar){
                ...
                if($("body").hasClass("auto-disabled-fullpage")){
                    return false;
                }
        ...
        */
        function stopMedia(destiny){
            ...
            destiny.find('audi-video').each(function (){
                var element = $(this).get(0);
  ...
  console.log('sect', section)
                ...
                if (section.find('.cmp-app-download').length && $('.stickyFeatureMenu').length) {
                  sectionHeight = sectionHeight - 96
                }
            }
  
            console.log(sectionHeight, element)
